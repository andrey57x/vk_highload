...
| ИТОГО: | Всего физических серверов в 3 ДЦ: | | 36 шт | | € 3,465 / мес |
...
Совокупная расчетная стоимость эксплуатации инфраструктуры составит примерно 3 465 Евро в месяц (с учетом 5-летней амортизации железа). Перенос подобного объема баз данных в Managed сервисы публичного облака (например, Yandex Cloud) обошелся бы в 4-6 раз дороже, что делает гибридный Bare-Metal подход единственным верным решением для проекта такого масштаба.
